...
class Oneline45(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for OneLine45 dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(OneLine45): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    path = dl_manager.download_and_extract('https://github.com/drawwithai/Dataset/raw/main/OneLine_45/OneLine_45.zip')
